...
service.interceptors.response.use(
  response => {
    ...
    // 业务失败，需要跳转到404页面
    if ((result.code !== "0" && result.code !== 0) && (result.state !== "200" && result.state !== 200) && (result.statusCode !== "200" && result.statusCode !== 200) && (result.code !== "200" && result.code !== 200) && (result.status !== "200" && result.status !== 200) && (result.code !== "2000" && result.code !== 2000)) {
